...
typedef struct __attribute__((__packed__)) packed_nodo_s
{
    ...
    uint32_t *arreglo;          // 8 => 16       asmdef_offset:PACKED_NODO_OFFSET_ARREGLO
    uint32_t longitud;          // 4 => 24       asmdef_offset:PACKED_NODO_OFFSET_LONGITUD
} packed_nodo_t;                // 28       asmdef_size:PACKED_NODO_SIZE
